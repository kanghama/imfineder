...
function Done() {
  return (
    <div className="bg-[red] content-stretch flex items-center justify-center px-[8px] py-[4px] relative rounded-[4px] shrink-0" data-name="Done">
      <div aria-hidden className="absolute border-[0.5px] border-[rgba(0,0,0,0.2)] border-solid inset-0 pointer-events-none rounded-[4px]" />
...
function Done1() {
  return (
    <div className="bg-white content-stretch flex items-center justify-center px-[8px] py-[4px] relative rounded-[4px] shrink-0" data-name="Done">
      <div aria-hidden className="absolute border-[0.5px] border-[rgba(0,0,0,0.2)] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="[word-break:break-word] font-['SF_Pro:Medium','Noto_Sans_KR:Medium',sans-serif] font-[510] leading-[normal] relative shrink-0 text-[#404040] text-[12px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        버튼
      </p>
    </div>
  );
...
export default function Modal() {
  return (
    <div className="bg-[#f6f6f6] content-stretch drop-shadow-[0px_10px_20px_rgba(0,0,0,0.4)] flex flex-col gap-[10px] items-start relative rounded-[14px] size-full" data-name="Modal">
