import svgPaths from "./svg-bs3si9annu";
...
function UilSetting() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="uil:setting">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="uil:setting">
          <path d={svgPaths.p36c52800} fill="var(--fill-0, #0076FF)" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="bg-[#eaeaea] relative rounded-[10px] shrink-0 w-full" data-name="Chat">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[12px] py-[8px] relative size-full">
          <UilSetting />
          <p className="[word-break:break-word] flex-[1_0_0] font-['SF_Pro:Medium','Noto_Sans_KR:Medium',sans-serif] font-[510] leading-[normal] min-w-px relative text-[#0076ff] text-[14px]" style={{ fontVariationSettings: '"wdth" 100' }}>
            개발자 설정
          </p>
          <div className="relative shrink-0 size-[11.314px]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.3137 11.3137">
              <path d={svgPaths.p2eaeaa00} fill="var(--fill-0, #0076FF)" id="Vector" />
            </svg>
          </div>
        </div>
      </div>
...
function Date() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[178px]" data-name="Date">
      <p className="[word-break:break-word] font-['SF_Pro:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#808080] text-[12px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        생성 날짜
      </p>
    </div>
...
export default function Developer() {
  return (
    <div className="bg-[#f6f6f6] content-stretch flex items-start relative size-full" data-name="Developer">
      <Left />
      <Right />
    </div>
  );
